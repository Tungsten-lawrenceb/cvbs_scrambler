// 0040a92b  undefined FUN_0040a92b(int * param_1, char param_2)
// callers: 3  callees: 14


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_0040a92b(int *param_1,char param_2)

{
  ...
  if (local_48 != 0) {
    if (param_2 == '\0') {
      *(ulonglong *)(local_48 + 0x6b8) = *(ulonglong *)(local_48 + 0x6b8) & 0xfffffffffffffffd;
    }
    else {
      *(ulonglong *)(local_48 + 0x6b8) = *(ulonglong *)(local_48 + 0x6b8) | 2;
    }
    local_58.left = 0;
    local_58.top = 0;
    local_58.right = 0;
        ...
        if ((1.0 < (double)(((longlong)local_68.right - (longlong)local_68.left) *
          ...
          if (0.8 < (double)(((longlong)local_58.right - (longlong)local_58.left) *
                    ...
                    (double)(((longlong)local_78.right - (longlong)local_78.left) *
                            ((longlong)local_78.bottom - (longlong)local_78.top))) {
            if (param_2 == '\0') {
              if ((*(ulonglong *)(local_48 + 0x6b8) & 2) == 0) {
                FUN_0042b090((undefined8 *)&DAT_004361f0,4,-1,0,1);
                *(undefined4 *)((longlong)local_84 * 4 + _DAT_004361f0) =
                     *(undefined4 *)(local_80 + 0x24);
                local_84 = local_84 + 1;
              }
              else {
                *(ulonglong *)(local_80 + 0x6b8) =
                     *(ulonglong *)(local_80 + 0x6b8) & 0xfffffffffffffffd;
              }
            }
            else {
              *(ulonglong *)(local_80 + 0x6b8) = *(ulonglong *)(local_80 + 0x6b8) | 2;
              lVar2 = FUN_0042b310((longlong *)&DAT_004361f0,1);
              if (-1 < lVar2) {
                local_88 = 0;
                lVar2 = FUN_0042b310((longlong *)&DAT_004361f0,1);
                for (; local_88 <= (int)lVar2; local_88 = local_88 + 1) {
                  if (*(int *)((longlong)local_88 * 4 + _DAT_004361f0) == *(int *)(local_80 + 0x24))
                  {
                    *(ulonglong *)(local_80 + 0x6b8) =
                         *(ulonglong *)(local_80 + 0x6b8) & 0xfffffffffffffffd;
                    break;
    ...
    if (local_84 == 0) {
      FUN_0042ac00((undefined8 *)&DAT_004361f0);
    }
      ...
      if ((1.0 < (double)(((longlong)local_68.right - (longlong)local_68.left) *
        ...
        if (0.8 < (double)(((longlong)local_58.right - (longlong)local_58.left) *
                  ...
                  (double)(((longlong)local_78.right - (longlong)local_78.left) *
                          ((longlong)local_78.bottom - (longlong)local_78.top))) {
          if (param_2 == '\0') {
            BVar1 = IsWindowVisible(local_98);
            if (BVar1 == 0) {
              FUN_0042b090((undefined8 *)&DAT_004362e0,8,-1,0,1);
              *(HWND *)((longlong)local_84 * 8 + _DAT_004362e0) = local_98;
              local_84 = local_84 + 1;
            }
            else {
              ShowWindow(local_98,0);
            }
          }
          else {
            ShowWindow(local_98,4);
            lVar2 = FUN_0042b310((longlong *)&DAT_004362e0,1);
            if (-1 < lVar2) {
              local_88 = 0;
              lVar2 = FUN_0042b310((longlong *)&DAT_004362e0,1);
              for (; local_88 <= (int)lVar2; local_88 = local_88 + 1) {
                if (*(HWND *)((longlong)local_88 * 8 + _DAT_004362e0) == local_98) {
                  ShowWindow(local_98,0);
                  break;
                }
              }
